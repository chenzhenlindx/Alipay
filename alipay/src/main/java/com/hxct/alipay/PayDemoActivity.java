...
import com.hxct.alipay.util.OrderInfoUtil2_0;
...
public class PayDemoActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AlipayHelper.payV2(PayDemoActivity.this, orderInfo)
                .subscribe(new Consumer<PayResult>() {
                    ...
                    public void accept(PayResult payResult) throws Exception {
                        if (AlipayHelper.isSuccess(payResult)) {
                            Result result = AlipayHelper.getResult(payResult);
                            //这里可以使用result信息去更新后台的订单
                        } else {
